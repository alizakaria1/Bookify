...
public class ReserveBookingTests
{
    ...
    /// <summary>
    /// since ReserveBookingCommandHandler is internal, normally we can't use it here. But we were able to by going to the project file
    /// of the Bookify.Application and adding the following
    /// <ItemGroup>
